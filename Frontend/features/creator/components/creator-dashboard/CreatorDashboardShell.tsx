            ...
            <button
              ...
              className={
                activeSection === item.label
                  ? "flex w-full items-center gap-3 rounded-[8px] bg-[#eef1ff] px-3 py-2.5 text-left text-sm font-bold text-[#6174f8] transition"
                  : "flex w-full items-center gap-3 rounded-[8px] px-3 py-2.5 text-left text-sm font-bold text-[#555866] transition hover:bg-[#f7f8fc] hover:text-[#17171f]"
              }
              type="button"
          ...
          <header className="sticky top-0 z-40 border-b border-[#e7e9f2] bg-white/92 backdrop-blur-xl">
            <div className="flex h-16 items-center justify-between gap-3 px-4 lg:px-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <button className="inline-flex h-10 items-center gap-2 rounded-[8px] bg-[#6174f8] px-4 text-sm font-black text-white shadow-[0_10px_20px_rgba(76,91,210,0.24)]" type="button" onClick={onFindCampaigns}>
